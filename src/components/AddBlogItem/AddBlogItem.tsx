    ...
    <div>
      <form className={`${styles["add-blog-item"]}`}>
        ...
        <div className={`${styles["add-blog-button"]}`}>
          <button
            className="text-white inline-flex items-center mt-2 bg-custom-blue hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            type="button"
